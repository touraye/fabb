...
import { infrastructure_images } from '@/constant';


function InfrastrutureGallery() {
    ...
    <div className='w-full xl:pt-8 md:pt-3'>
        <main className="flex flex-col items-center justify-center py-6 m-auto">
            ...
            <Lightbox
              ...
              close={() => setOpen(false)}
              index={index}
              slides={infrastructure_images.map((img) => ({ src: img.src }))}
...
export default InfrastrutureGallery